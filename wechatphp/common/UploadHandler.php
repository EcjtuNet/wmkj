...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().'/fileindex.php',
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/audio/'.date("Ymd").'/',
            'upload_url' => $this->get_full_url().'/audio/'.date("Ymd").'/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $file->pre_name = $file->name;
            $file->name = time().".".end($path);
            $file_path = "./audio/".date("Ymd")."/".$file->name;
